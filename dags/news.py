...
def download(task_instance):
    file_urls = task_instance.xcom_pull(task_ids=f'Find_{OBJECT}')
...
with DAG(f'teste_{OBJECT}', start_date=datetime(2022,12,16), schedule_interval=None, catchup= False, tags=['VERSIONAMENTO','S3']) as dag:
